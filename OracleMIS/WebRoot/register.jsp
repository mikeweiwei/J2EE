...
<html>
  <head>
	...
	<body>
		...
		<hr/>
		<br/>
		<form action="userServlet.action?method=regUser"  method="post" onsubmit="return checkAll();">
		<div id="out">
			<div class="int1">
				用户注册
			</div>
			...
			<label>
			<input type="checkbox" name="uagree" id="uagree" value="" class="int0"/> 
			&nbsp;我已阅读并同意本协议&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="spanagree"></span>
			</label>
			<div class="int6">
				<input type="submit" value="同意协议并注册" class="int01"/>
			</div>
		</div>
		</form>
	</body>
