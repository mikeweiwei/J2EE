  ...
  <head>
    <base href="<%=basePath%>">
		...
		<script type="text/javascript">
			...
			function charbox() {
				if (document.getElementById("uagree").checked) {
					return true;
				} else {
					return false;
				}
	...
	<body>
		...
		<hr/>
		<br/>
		<form action="userServlet.action?method=modify"  method="post" onsubmit="return checkAll();">
		<div id="out">
			<div class="int1">
				修改用戶
			</div>
			<div class="int2">
				...
				<div class="int23">
					<input type="text" name="uname" id="uname" value="${name}" maxlength="10" class="int"/>
				</div>
			...
			<div class="int2">
				...
				<div class="int23">
					<input type="password" name="upwd" id="upwd" value="${password}" maxlength="8" class="int"/>
				</div>
			...
			<div class="int2">
				...
				<div class="int23">
					<input type="password" name="conpwd" id="conpwd" value="${password}" class="int"/>
				</div>
			...
			<div class="int2">
				...
				<div class="int23">
					<input type="tel" name="utel" id="utel" value="${phone}" class="int"/>
				</div>
			...
			<div class="int6">
				<input type="submit" value="修改" class="int01"/>
			</div>
		</div>
		</form>
	</body>
